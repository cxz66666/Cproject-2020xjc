...
static BOOL ChooseXaxis(double nowx, double nowy)
{
...
static BOOL ChooseYaxis(double nowx, double nowy)
{
...
static BOOL ChooseLine(double nowx, double nowy)
{
...
static BOOL ChooseHistogram(double nowx, double nowy)
{
	int i;
	if (DrawWithColumn == 2)
	{
